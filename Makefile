...
check-safety:
	...
	$(BANDIT_COMMAND_FLAG)poetry run bandit -ll -r wyze_rtsp_bridge/
...
check-style:
	...
	$(MYPY_COMMAND_FLAG)poetry run mypy --config-file setup.cfg wyze_rtsp_bridge tests/**/*.py
